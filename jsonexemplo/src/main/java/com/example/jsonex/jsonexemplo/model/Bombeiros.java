...
public class Bombeiros {
    ...
    private Long id; // Corrigido de int para Long
    private String nome;
    ...
    public Bombeiros(Long id, String nome, String cargo, String cpf, String telefone) { // Corrigido para Long
        this.id = id;
        this.nome = nome;
        this.cargo = cargo;
        this.cpf = cpf;
    ...
    // GETTERS
    public Long getId() { // Corrigido para Long
        return id;
    }
    ...
    // SETTERS
    public void setId(Long id) { // Corrigido para Long
        this.id = id;
    }
